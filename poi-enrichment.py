...
passing = KubernetesPodOperator(namespace='spark',
                          ...
                          env_vars={"MINIO_ENDPOINT": "http://minio.vvp.svc.cluster.local:9000",
                                    "JAR_PREFIX": "proximai-data/experiments/job_emr/poi-enricher-assembly-0.6.7.jar",
                          ...
                          arguments=[
                              ...
                              "--conf", "spark.driver.AWS_S3_ENDPOINT=http://127.0.0.1:9000",
                              "--conf", "spark.hadoop.fs.s3a.path.style.access=true",
                              "--deploy-mode", "client",
                              "--class", "ai.proxim.PoiEnrichment",
                              "/poi-enricher-assembly-0.6.7.jar"
                          ],
                          labels={"foo": "bar"},
                          name="passing-test",
