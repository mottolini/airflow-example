...
dag = DAG(
    'test-clustering-pipeline-schema', default_args=default_args, schedule_interval=timedelta(minutes=10))
...
passing = KubernetesPodOperator(namespace='spark',
                          ...
                          env_vars={"MINIO_ENDPOINT": "http://minio.vvp.svc.cluster.local:9000",
                                    ...
                                    "PYTHON_SCRIPT": "proximai-data/experiments/job_emr/test.py",
