...
dag = DAG(
    'poi_daily_density', default_args=default_args, schedule_interval=timedelta(minutes=10))
...
passing = KubernetesPodOperator(namespace='spark',
                          ...
                          env_vars={"MINIO_ENDPOINT": "http://minio.vvp.svc.cluster.local:9000",
                                    "JAR_PREFIX": "proximai-data/experiments/job_emr/poi-daily-density-assembly-0.6.1.jar",
                                    "AWS_ACCESS_KEY_ID": "admin",
                                    "AWS_SECRET_ACCESS_KEY": "WS46advKR",
                                    "ACCESS_KEY": "admin",
                                    "SECRET_KEY": "WS46advKR",
                                    "ENDPOINT": "http://minio.vvp.svc.cluster.local:9000",
                                    "WRITE_PATH_COMPACTOR": "s3a://proximai-data/datalake/inferreddata/dailyDensity/"
                                   },
                          arguments=[
                              ...
                              "--deploy-mode", "client",
                              "--class", "ai.proxim.DailyDensity",
                              "/poi-daily-density-assembly-0.6.1.jar"
                          ],
                          labels={"foo": "bar"},
                          name="passing-test",
